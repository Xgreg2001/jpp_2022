public class FiniteField implements Field<FiniteField> {
    ...
    @Override
    public FiniteField zero() {
        return new FiniteField(0, p);
    }

    @Override
    public FiniteField one() {
        return new FiniteField(1, p);
    }

    @Override
    public FiniteField negate() {
        return new FiniteField(-value, p);
    }

    public FiniteField pow(long exponent) {
